  ...
  navbarPage(title = NULL,
              ...
              tabPanel(title = span("Website Info", class = "navtitle"),
                      ...
                      div(class = "appinfo",
                         ...
                         a("Link to Report", href = "UIUC_Course_Data_Analysis.html"),
                         
                         tags$br(),
                         
                         a("Link to Github Repository for this Project", href = "https://github.com/svetrie/UIUC-Course-Data-Explorer")
                       )
